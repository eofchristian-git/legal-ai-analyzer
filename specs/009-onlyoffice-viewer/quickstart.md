...
```
[Clause View] [Document View] [Legacy View]
```

Click **Document View** button (this loads the ONLYOFFICE viewer).

> **Note**: "Legacy View" is the deprecated Feature 008 HTML viewer, retained for backward compatibility with contracts analyzed before ONLYOFFICE integration.
...
3. ✅ **Phase 4: Deprecation** — Remove deprecated HTML viewer code (legacy contracts retain their existing viewer)
